...
public class DataBase {
    ...
    public void initializeDataBase() {
        ...
        User admin = new User(1, "admin", "admin", "admin", "admin", 2,"admin@gmail.com", UserRole.ADMIN, Gender.OTHERS, newLoginDates);
        admin.teacherCourses.add(course);
        admin.teacherCourses.add(course2);
        admin.stdCourses.add(course3);
        admin.stdCourses.add(course4);

        User admin2 = new User(2, "admin2", "admin2", "admin2", "admin2", 2,"admin2@gmail.com", UserRole.ADMIN, Gender.OTHERS, newLoginDates);
